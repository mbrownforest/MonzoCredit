...
public class UserCreditValues implements Serializable {
    ...
    String getMonzoPotName(Context context) {
    ...
    void setMonzoPotName(Context context, String monzoPotName) {
        SharedPreferences sharedPref = context.getSharedPreferences(STORAGE, Context.MODE_PRIVATE);
    ...
    String getCreditCardNotification(Context context) {
        SharedPreferences sharedPref = context.getSharedPreferences(STORAGE, Context.MODE_PRIVATE);
        return sharedPref.getString(CREDIT_CARD_NOTIFICATION, null);
    }

    void setCreditCardNotification(Context context, String creditCardNotification) {
        SharedPreferences sharedPref = context.getSharedPreferences(STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
